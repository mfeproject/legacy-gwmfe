...
*      Load the inner products.
       term = c*l(j,k)*i1
       g(j,1,kp1) = g(j,1,kp1) - term
       g(j,1,km1) = g(j,1,km1) - term

       term = c*( i2*du(j,3,k) + dudt*i1*du(j,2,k))
       g(j,2,kp1) = g(j,2,kp1) + term
       g(j,2,km1) = g(j,2,km1) + term

       term = c*(-i2*du(j,2,k) + dudt*i1*du(j,3,k))
       g(j,3,kp1) = g(j,3,kp1) + term
       g(j,3,km1) = g(j,3,km1) + term
   10 continue
