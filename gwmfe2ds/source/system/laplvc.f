      subroutine laplvc(n,ieq,dalpha)
************************************************************************
*
*   LAPLVC --
*
...
*      Load the inner products.
       term = wpde(ieq)*l(j,k)*i1
       g(j,ieq,kp1) = g(j,ieq,kp1) - dalpha(j,kp1,k)*term
       g(j,ieq,km1) = g(j,ieq,km1) - dalpha(j,km1,k)*term

       term = wpde(ieq)*( i2*du(j,yeq,k) + dudt*i1*du(j,xeq,k))
       g(j,xeq,kp1) = g(j,xeq,kp1) + dalpha(j,kp1,k)*term
       g(j,xeq,km1) = g(j,xeq,km1) + dalpha(j,km1,k)*term

       term = wpde(ieq)*(-i2*du(j,xeq,k) + dudt*i1*du(j,yeq,k))
       g(j,yeq,kp1) = g(j,yeq,kp1) + dalpha(j,kp1,k)*term
       g(j,yeq,km1) = g(j,yeq,km1) + dalpha(j,km1,k)*term
   10 continue
