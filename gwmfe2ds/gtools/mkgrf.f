      ...
      integer mpde,mnod
      parameter(mpde=4,mnod=2000)

      real*8 t,y((mpde+2)*mnod)
      integer npde,nnod,n
...
*  110 format(a,$)
  ...
  130 format(a)
      ...
      n = 0
   10 n = n + 1
      call rdsoln(nnod,npde,  t,y,title,  *20,*910)
      call wrsoln(nnod,npde,t,y,title)
...
************************************************************************
      ...
      parameter(mpde=4,mnod=2000,mtri=2*mnod,medg=3*mnod)
...
***** Bad .gp2lbl file.
  920 return 2
      ...
      subroutine rdsoln(nnod,npde,  t,y,label,  *,*)
************************************************************************
*
...
************************************************************************
      ...
      real*8 t,y(npde+2,nnod),h,cputime
